...
import com.dimsteams.sodiumpp.mixins.common.accessors.EntityTypeAccessor;
...
public class EntityUtils {
    ...
    private static synchronized void loadEntityClasses() {
        ...
        Registries.ENTITY_TYPES.getValues().stream().map(et -> {
            ...
            String key = com.dimsteams.sodiumpp.common.Registries.ENTITY_TYPES.getKey(et).toString();
    ...
    private static Optional<Class<?>> findEntityClassFromException(Throwable throwable) {
        ...
        // find index of first com.dimsteams.sodiumpp.EntityUtils class in stack trace
