...
import com.dimsteams.sodiumpp.common.IKeyBindingRegistry;
...
public class KeyBindingsController {
    ...
    private KeyBindingsController() {
        ...
        for (int i = 0; i < keys.length; i++) {
            keys[i] = new KeyMapping("key.dimsteams.sodiumpp.reserved" + i, InputConstants.UNKNOWN.getValue(), category);
        }
