...
import com.dimsteams.sodiumpp.scripting.*;
import com.dimsteams.scripting.InterfaceHelper;
...
public class ScriptsDocsApi extends ApiBase {
    ...
    private String formatClass(Class<?> clazz) {
        ...
        if (clazz == void.class) {
            ...
            shouldWrap = false;
        } else if (clazz.getName().startsWith("com.dimsteams.sodiumpp.scripting.modules.")) {
            name = clazz.getName().substring("com.dimsteams.sodiumpp.scripting.modules.".length());
        } else if (clazz.getName().startsWith("com.dimsteams.sodiumpp.scripting.events.")) {
            name = clazz.getName().substring("com.dimsteams.sodiumpp.scripting.events.".length());
