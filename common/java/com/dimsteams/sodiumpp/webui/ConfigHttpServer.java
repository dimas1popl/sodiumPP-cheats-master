...
import com.dimsteams.sodiumpp.scripting.monaco.Integration;
...
public class ConfigHttpServer {
    ...
    public synchronized void start() {
        ...
        server.createContext("/llm/sodiumpp-llm-guide.md", new LargeLanguageModelGuideHandler());
        server.createContext("/llm/sodiumpp-api.txt", new ApiGenHandler());
