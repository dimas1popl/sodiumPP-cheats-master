...
import com.dimsteams.sodiumpp.configs.ConfigWriterQueue;
...
public class Profiles implements Module {
    ...
    private static final String OLD_CONFIG_FILE_NAME = "dimsteamssodiumpp.json";
    private static final String PROFILE_CONFIG_FILE_NAME = "sodiumpp-profile.json";
    private static final String DEFAULT_CONFIG_FILE_NAME = "sodiumpp.json";
    private static final String CONFIG_FILE_NAME = "sodiumpp.%s.json";

    private final Logger logger = LogManager.getLogger(Profiles.class);
    private final char[] invalidChars = new char[] { '\\', '/', ':', '*', '?', '"', '<', '>', '|' };
    private final Pattern pattern = Pattern.compile("^sodiumpp\\.(.+)\\.json$");
