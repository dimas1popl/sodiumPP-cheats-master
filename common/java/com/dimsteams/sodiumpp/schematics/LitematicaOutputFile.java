package com.dimsteams.sodiumpp.schematics;

import com.dimsteams.sodiumpp.modules.automation.Schematica;
import com.dimsteams.sodiumpp.utils.BlockStateMapper;
...
public class LitematicaOutputFile {
    ...
    private static CompoundTag createMetadata(SchematicaOutputData data) {
        ...
        compound.putString("Name", "sodiumpp");
        compound.putString("Author", "sodiumpp");
        compound.putString("Description", "sodiumpp");
