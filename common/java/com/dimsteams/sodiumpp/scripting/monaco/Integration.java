...
import com.dimsteams.sodiumpp.scripting.ScriptType;
import com.dimsteams.sodiumpp.utils.ColorUtils;
import com.dimsteams.sodiumpp.webui.WebHelper;
import com.dimsteams.scripting.TextRange;
import com.dimsteams.scripting.analysis.definition.DefinitionProvider;
import com.dimsteams.scripting.binding.Binder;
import com.dimsteams.scripting.binding.BinderOutput;
import com.dimsteams.scripting.compiler.CompilationParameters;
import com.dimsteams.scripting.completion.CompletionProviderFactory;
import com.dimsteams.scripting.highlighting.HighlightingProvider;
import com.dimsteams.scripting.highlighting.SemanticToken;
import com.dimsteams.scripting.highlighting.SemanticTokenModifier;
import com.dimsteams.scripting.highlighting.SemanticTokenType;
import com.dimsteams.scripting.hover.HoverProvider;
import com.dimsteams.scripting.lexer.*;
import com.dimsteams.scripting.parser.Parser;
import com.dimsteams.scripting.parser.ParserOutput;
...
public class Integration {
    ...
    public void attach(HttpServer server, String prefix) {
        ...
        Pattern regex = Pattern.compile("Java<com\\.dimsteams\\.sodiumpp\\.scripting\\.modules\\.(.+)>");
