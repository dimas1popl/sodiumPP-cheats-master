...
import com.dimsteams.scripting.completion.SuggestionFactory;
import com.dimsteams.scripting.lexer.TokenType;
import com.dimsteams.scripting.symbols.*;
import com.dimsteams.scripting.type.*;
...
public class MonacoSuggestionFactory implements SuggestionFactory<Suggestion> {
    ...
    private String type(SType type) {
        if (type instanceof SClassType classType) {
            ...
            if (clazz.getName().startsWith("com.dimsteams.sodiumpp.scripting")) {
