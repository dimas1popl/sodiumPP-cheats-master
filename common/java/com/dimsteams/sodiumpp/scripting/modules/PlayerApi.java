...
import com.dimsteams.sodiumpp.controllers.DisconnectController;
import com.dimsteams.sodiumpp.controllers.SpeedCounterController;
import com.dimsteams.sodiumpp.mixins.common.accessors.LocalPlayerAccessor;
import com.dimsteams.sodiumpp.mixins.common.accessors.MultiPlayerGameModeAccessor;
...
import com.dimsteams.sodiumpp.scripting.types.HitResultWrapper;
import com.dimsteams.sodiumpp.scripting.types.Position3d;
import com.dimsteams.sodiumpp.utils.*;
    ...
    public static class TargetApi {
        ...
        public String getBlockName() {
            ...
            if (result.getType() == HitResult.Type.BLOCK) {
                ...
                return com.dimsteams.sodiumpp.common.Registries.BLOCKS.getKey(blockState.getBlock()).toString();
            } else {
                return "";
            }
        }
