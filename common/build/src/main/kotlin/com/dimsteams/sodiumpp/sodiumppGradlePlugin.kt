package com.dimsteams.sodiumpp
...
open class sodiumppExtension(private val project: Project) {
...
class sodiumppGradlePlugin : Plugin<Project> {
    override fun apply(project: Project) {
        val ext = project.extensions.create("sodiumpp", sodiumppExtension::class.java, project)
        ...
        project.tasks.register("generateCommitsJson") {
            ...
            doLast {
                ...
                file.writeText("""{"sodiumpp":"$cuCommit","java-scripting-language":"$jslCommit"}""")
            }
        }
